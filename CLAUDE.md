...
4. **Проверь критерии готовности** — в деталях задачи есть список критериев. Выполни реальные проверки (запусти команды, проверь API, посмотри результат) и поставь `- [x]` у каждого выполненного критерия
5. **Остановись** и дождись моего ревью
